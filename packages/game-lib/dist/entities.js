...
var init_box = __esm({
  "src/lib/entities/box.ts"() {
    ...
    boxDefaults = {
      ...commonDefaults,
      size: new Vector34(1, 1, 1)
    };
    BoxCollisionBuilder = class extends EntityCollisionBuilder {
      collider(options) {
        const size = options.size || new Vector34(1, 1, 1);
        const half = { x: size.x / 2, y: size.y / 2, z: size.z / 2 };
...
import { Euler, Group as Group3, Quaternion as Quaternion2, Vector3 as Vector35 } from "three";
import {
...
var init_XZPlaneGeometry = __esm({
  "src/lib/graphics/geometries/XZPlaneGeometry.ts"() {
    "use strict";
    XZPlaneGeometry = class _XZPlaneGeometry extends BufferGeometry3 {
...
import { PlaneGeometry, Vector2 as Vector23, Vector3 as Vector36 } from "three";
...
import { Color as Color8, Group as Group4, Sprite as ThreeSprite2, SpriteMaterial as SpriteMaterial2, CanvasTexture, LinearFilter, Vector2 as Vector24, ClampToEdgeWrapping } from "three";
...
import { Color as Color9, Group as Group5, Sprite as ThreeSprite3, SpriteMaterial as SpriteMaterial3, CanvasTexture as CanvasTexture2, LinearFilter as LinearFilter2, Vector2 as Vector25, ClampToEdgeWrapping as ClampToEdgeWrapping2, ShaderMaterial as ShaderMaterial3, Mesh as Mesh4, PlaneGeometry as PlaneGeometry2, Vector3 as Vector38 } from "three";
    ...
    ZylemRect = class _ZylemRect extends GameEntity {
      ...
      computeScreenBoundsFromOptions(bounds) {
        ...
        if (bounds.world) {
          ...
          const tl = this.worldToScreen(new Vector38(left, top, z));
          const br = this.worldToScreen(new Vector38(right, bottom, z));
...
import { MeshStandardMaterial as MeshStandardMaterial3, Group as Group6, Vector3 as Vector39 } from "three";
...
var init_actor = __esm({
  "src/lib/entities/actor.ts"() {
    ...
    actorDefaults = {
      ...
      collision: {
        static: false,
        size: new Vector39(0.5, 0.5, 0.5),
        position: new Vector39(0, 0, 0)
      },
      material: {
        shader: standardShader
      },
    ...
    ActorCollisionBuilder = class extends EntityCollisionBuilder {
      ...
      createColliderFromModel(objectModel, options) {
        ...
        if (collisionSize) {
          ...
          let colliderDesc2 = ColliderDesc7.cuboid(halfWidth, halfHeight, halfDepth);
