import { S as SetupFunction, G as GameEntity, U as UpdateFunction, D as DestroyFunction, a as SetupContext, b as UpdateContext, c as DestroyContext, B as BaseNode, L as LoadingEvent, d as BehaviorSystem, e as BehaviorSystemFactory, f as StageEvents } from './entity-ts-8CIGZ.js';
import * as bitecs from 'bitecs';
import { defineSystem, IWorld } from 'bitecs';
import { Scene, Color, Object3D, Vector3, Group } from 'three';
import { Z as ZylemWorld, S as SPRITE_TYPE, a as ZylemSprite, b as SPHERE_TYPE, c as ZylemSphere, R as RECT_TYPE, d as ZylemRect, T as TEXT_TYPE, e as ZylemText, B as BOX_TYPE, f as ZylemBox, P as PLANE_TYPE, g as ZylemPlane, h as ZONE_TYPE, i as ZylemZone, A as ACTOR_TYPE, j as ZylemActor } from './entities-CVb8vLFG.js';
