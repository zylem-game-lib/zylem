import { G as GameEntity, b as UpdateContext, g as GameEntityOptions, c as DestroyContext, B as BaseNode, T as TexturePath, V as Vec3, M as MaterialOptions } from './entity-ts-8CIGZ.js';
...
export { ACTOR_TYPE as A, BOX_TYPE as B, PLANE_TYPE as P, RECT_TYPE as R, SPRITE_TYPE as S, TEXT_TYPE as T, ZylemWorld as Z, ZylemSprite as a, SPHERE_TYPE as b, ZylemSphere as c, ZylemRect as d, ZylemText as e, ZylemBox as f, ZylemPlane as g, ZONE_TYPE as h, ZylemZone as i, ZylemActor as j, createBox as k, createSphere as l, createSprite as m, createPlane as n, createZone as o, createActor as p, createText as q, createRect as r };
