...
import { MeshStandardMaterial as MeshStandardMaterial2, Group as Group3, Vector3 as Vector34 } from "three";
...
var init_zylem_scene = __esm({
  "src/lib/graphics/zylem-scene.ts"() {
    ...
    ZylemScene = class {
       ...
       * Add object to scene
       */
      add(object, position2 = new Vector35(0, 0, 0)) {
      ...
      addEntityGroup(entity) {
        const position2 = entity.body ? new Vector35(
...
var init_stage_state = __esm({
  "src/lib/stage/stage-state.ts"() {
    ...
    stageState = proxy3({
      backgroundColor: new Color7(Color7.NAMES.cornflowerblue),
      backgroundImage: null,
      inputs: {
  ...
  "src/lib/stage/zylem-stage.ts"() {
    ...
    ZylemStage = class extends LifeCycleBase {
      ...
      setState() {
        ...
        const color = backgroundColor instanceof Color10 ? backgroundColor : new Color10(backgroundColor);
...
import { Color as Color11, Group as Group5, Sprite as ThreeSprite, SpriteMaterial, CanvasTexture, LinearFilter, Vector2 as Vector29, ClampToEdgeWrapping } from "three";
  ...
  "src/lib/entities/text.ts"() {
    ...
    ZylemText = class _ZylemText extends GameEntity {
      ...
      toCssColor(color) {
        ...
        const c = color instanceof Color11 ? color : new Color11(color);
...
var boxDefaults, BoxCollisionBuilder, BoxMeshBuilder, BoxBuilder, BOX_TYPE, ZylemBox;
var init_box = __esm({
  "src/lib/entities/box.ts"() {
    "use strict";
    init_entity();
    ...
    BoxBuilder = class extends EntityBuilder {
      createEntity(options) {
        return new ZylemBox(options);
      }
    };
    BOX_TYPE = /* @__PURE__ */ Symbol("Box");
    ZylemBox = class _ZylemBox extends GameEntity {
...
import { SphereGeometry as SphereGeometry2 } from "three";
...
var sphereDefaults, SphereCollisionBuilder, SphereMeshBuilder, SphereBuilder, SPHERE_TYPE, ZylemSphere;
var init_sphere = __esm({
  "src/lib/entities/sphere.ts"() {
    ...
    SphereCollisionBuilder = class extends EntityCollisionBuilder {
      collider(options) {
    ...
    SphereMeshBuilder = class extends EntityMeshBuilder {
      build(options) {
        const radius = options.radius ?? 1;
        return new SphereGeometry2(radius);
      }
    };
    SphereBuilder = class extends EntityBuilder {
      createEntity(options) {
        return new ZylemSphere(options);
      }
    };
    SPHERE_TYPE = /* @__PURE__ */ Symbol("Sphere");
    ZylemSphere = class _ZylemSphere extends GameEntity {
...
var DEFAULT_SUBDIVISIONS, planeDefaults, PlaneCollisionBuilder, PlaneMeshBuilder, PlaneBuilder, PLANE_TYPE, ZylemPlane;
var init_plane = __esm({
  "src/lib/entities/plane.ts"() {
    ...
    PlaneCollisionBuilder = class extends EntityCollisionBuilder {
      collider(options) {
    ...
    PlaneMeshBuilder = class extends EntityMeshBuilder {
    ...
    PlaneBuilder = class extends EntityBuilder {
      createEntity(options) {
        return new ZylemPlane(options);
      }
    };
    PLANE_TYPE = /* @__PURE__ */ Symbol("Plane");
    ZylemPlane = class extends GameEntity {
...
var zoneDefaults, ZoneCollisionBuilder, ZoneBuilder, ZONE_TYPE, ZylemZone;
var init_zone = __esm({
  "src/lib/entities/zone.ts"() {
    "use strict";
    init_entity();
    ...
    ZoneBuilder = class extends EntityBuilder {
      createEntity(options) {
        return new ZylemZone(options);
      }
    };
    ZONE_TYPE = /* @__PURE__ */ Symbol("Zone");
    ZylemZone = class extends GameEntity {
...
var rectDefaults, RectBuilder, RECT_TYPE, ZylemRect;
var init_rect = __esm({
  "src/lib/entities/rect.ts"() {
    "use strict";
    init_entity();
    ...
    RectBuilder = class extends EntityBuilder {
      createEntity(options) {
        return new ZylemRect(options);
      }
    };
    RECT_TYPE = /* @__PURE__ */ Symbol("Rect");
    ZylemRect = class _ZylemRect extends GameEntity {
      ...
      redrawRect() {
        ...
        if (this._texture) {
          if (sizeChanged) {
            ...
            if (this._sprite && this._sprite.material instanceof ShaderMaterial5) {
      ...
      rectSetup(params) {
        ...
        if (this.materials?.length && this._sprite) {
          ...
          if (mat instanceof ShaderMaterial5) {
...
// src/lib/entities/disk.ts
import { ColliderDesc as ColliderDesc8 } from "@dimforge/rapier3d-compat";
import { Group as Group8, RingGeometry } from "three";
function createDisk(...args) {
  return createEntity({
    args,
...
var diskDefaults, DiskCollisionBuilder, DiskMeshBuilder, DiskBuilder, DISK_TYPE, ZylemDisk;
var init_disk = __esm({
  "src/lib/entities/disk.ts"() {
    "use strict";
    init_entity();
    ...
    DiskCollisionBuilder = class extends EntityCollisionBuilder {
      collider(options) {
        const outerRadius = options.outerRadius ?? 1;
        const height = 0.1;
        let colliderDesc = ColliderDesc8.cylinder(height / 2, outerRadius);
        return colliderDesc;
      }
    };
    DiskMeshBuilder = class extends EntityMeshBuilder {
      build(options) {
    ...
    DiskBuilder = class extends EntityBuilder {
      createEntity(options) {
      ...
      build() {
        ...
        if (entity.mesh && !entity.group) {
          entity.group = new Group8();
          entity.group.add(entity.mesh);
        }
        return entity;
      }
    };
    DISK_TYPE = /* @__PURE__ */ Symbol("Disk");
    ZylemDisk = class _ZylemDisk extends GameEntity {
...
var init_behavior_descriptor = __esm({
  "src/lib/behaviors/behavior-descriptor.ts"() {
    "use strict";
  }
});
...
var PhysicsStepBehavior;
var init_physics_step_behavior = __esm({
  "src/lib/behaviors/physics-step.behavior.ts"() {
    "use strict";
    PhysicsStepBehavior = class {
...
var PhysicsSyncBehavior;
var init_physics_sync_behavior = __esm({
  "src/lib/behaviors/physics-sync.behavior.ts"() {
    "use strict";
    PhysicsSyncBehavior = class {
      constructor(world) {
        this.world = world;
      }
      /**
...
var ThrusterState, ThrusterEvent, ThrusterFSM;
var init_thruster_fsm = __esm({
  "src/lib/behaviors/thruster/thruster-fsm.ts"() {
    "use strict";
    ThrusterState = /* @__PURE__ */ ((ThrusterState2) => {
    ...
    ThrusterEvent = /* @__PURE__ */ ((ThrusterEvent2) => {
...
var ThrusterMovementBehavior;
var init_thruster_movement_behavior = __esm({
  "src/lib/behaviors/thruster/thruster-movement.behavior.ts"() {
    "use strict";
    ThrusterMovementBehavior = class {
      constructor(world) {
        this.world = world;
      }
      /**
...
var defaultOptions, ThrusterBehaviorSystem, ThrusterBehavior;
var init_thruster_descriptor = __esm({
  "src/lib/behaviors/thruster/thruster.descriptor.ts"() {
    "use strict";
    init_behavior_descriptor();
    init_thruster_movement_behavior();
    init_thruster_fsm();
    defaultOptions = {
      linearThrust: 10,
      angularThrust: 5
    };
    ThrusterBehaviorSystem = class {
      constructor(world) {
        this.world = world;
    ...
    ThrusterBehavior = defineBehavior({
      name: "thruster",
      defaultOptions,
...
var init_thruster = __esm({
  "src/lib/behaviors/thruster/index.ts"() {
    ...
    init_thruster_fsm();
    init_thruster_movement_behavior();
    init_thruster_descriptor();
  }
});

// src/lib/behaviors/screen-wrap/screen-wrap-fsm.ts
import { StateMachine as StateMachine2, t as t2 } from "typescript-fsm";
var ScreenWrapState, ScreenWrapEvent, ScreenWrapFSM;
var init_screen_wrap_fsm = __esm({
  "src/lib/behaviors/screen-wrap/screen-wrap-fsm.ts"() {
    "use strict";
    ScreenWrapState = /* @__PURE__ */ ((ScreenWrapState2) => {
    ...
    ScreenWrapEvent = /* @__PURE__ */ ((ScreenWrapEvent2) => {
...
var defaultOptions2, ScreenWrapSystem, ScreenWrapBehavior;
var init_screen_wrap_descriptor = __esm({
  "src/lib/behaviors/screen-wrap/screen-wrap.descriptor.ts"() {
    "use strict";
    init_behavior_descriptor();
    init_screen_wrap_fsm();
    defaultOptions2 = {
      width: 20,
      height: 15,
      centerX: 0,
    ...
    ScreenWrapBehavior = defineBehavior({
      name: "screen-wrap",
...
var WorldBoundary2DState, WorldBoundary2DEvent, WorldBoundary2DFSM;
var init_world_boundary_2d_fsm = __esm({
  "src/lib/behaviors/world-boundary-2d/world-boundary-2d-fsm.ts"() {
    "use strict";
    WorldBoundary2DState = /* @__PURE__ */ ((WorldBoundary2DState2) => {
    ...
    WorldBoundary2DEvent = /* @__PURE__ */ ((WorldBoundary2DEvent2) => {
...
var defaultOptions3, WorldBoundary2DSystem, WorldBoundary2DBehavior;
var init_world_boundary_2d_descriptor = __esm({
  "src/lib/behaviors/world-boundary-2d/world-boundary-2d.descriptor.ts"() {
    "use strict";
    init_behavior_descriptor();
    init_world_boundary_2d_fsm();
    defaultOptions3 = {
      boundaries: { top: 0, bottom: 0, left: 0, right: 0 }
    };
    WorldBoundary2DSystem = class {
      constructor(world) {
        this.world = world;
      }
      update(_ecs, _delta) {
    ...
    WorldBoundary2DBehavior = defineBehavior({
...
var init_world_boundary_2d = __esm({
  "src/lib/behaviors/world-boundary-2d/index.ts"() {
    "use strict";
    init_world_boundary_2d_descriptor();
    init_world_boundary_2d_fsm();
  }
});
...
var Ricochet2DState, Ricochet2DEvent, Ricochet2DFSM;
var init_ricochet_2d_fsm = __esm({
  "src/lib/behaviors/ricochet-2d/ricochet-2d-fsm.ts"() {
    "use strict";
    Ricochet2DState = /* @__PURE__ */ ((Ricochet2DState2) => {
      Ricochet2DState2["Idle"] = "idle";
      Ricochet2DState2["Ricocheting"] = "ricocheting";
      return Ricochet2DState2;
    })(Ricochet2DState || {});
    Ricochet2DEvent = /* @__PURE__ */ ((Ricochet2DEvent2) => {
...
var defaultOptions4, Ricochet2DSystem, Ricochet2DBehavior;
var init_ricochet_2d_descriptor = __esm({
  "src/lib/behaviors/ricochet-2d/ricochet-2d.descriptor.ts"() {
    "use strict";
    init_behavior_descriptor();
    init_ricochet_2d_fsm();
    defaultOptions4 = {
      minSpeed: 2,
      maxSpeed: 20,
      speedMultiplier: 1.05,
    ...
    Ricochet2DBehavior = defineBehavior({
      name: "ricochet-2d",
...
var MovementSequence2DState, MovementSequence2DEvent, MovementSequence2DFSM;
var init_movement_sequence_2d_fsm = __esm({
  "src/lib/behaviors/movement-sequence-2d/movement-sequence-2d-fsm.ts"() {
    "use strict";
    MovementSequence2DState = /* @__PURE__ */ ((MovementSequence2DState2) => {
    ...
    MovementSequence2DEvent = /* @__PURE__ */ ((MovementSequence2DEvent2) => {
...
var defaultOptions5, MovementSequence2DSystem, MovementSequence2DBehavior;
var init_movement_sequence_2d_descriptor = __esm({
  "src/lib/behaviors/movement-sequence-2d/movement-sequence-2d.descriptor.ts"() {
    "use strict";
    init_behavior_descriptor();
    init_movement_sequence_2d_fsm();
    defaultOptions5 = {
      sequence: [],
      loop: true
    };
    MovementSequence2DSystem = class {
      constructor(world) {
        this.world = world;
      }
      update(_ecs, delta) {
    ...
    MovementSequence2DBehavior = defineBehavior({
...
var init_movement_sequence_2d = __esm({
  "src/lib/behaviors/movement-sequence-2d/index.ts"() {
    "use strict";
    init_movement_sequence_2d_fsm();
    init_movement_sequence_2d_descriptor();
  }
});

// src/lib/coordinators/boundary-ricochet.coordinator.ts
var BoundaryRicochetCoordinator;
var init_boundary_ricochet_coordinator = __esm({
  "src/lib/coordinators/boundary-ricochet.coordinator.ts"() {
    "use strict";
    BoundaryRicochetCoordinator = class {
...
var init_behaviors = __esm({
  "src/lib/behaviors/index.ts"() {
    ...
    init_use_behavior();
    init_components();
    init_physics_step_behavior();
    init_physics_sync_behavior();
    init_thruster();
    init_screen_wrap();
...
var init_ping_pong_sound = __esm({
  "src/lib/sounds/ping-pong-sound.ts"() {
    "use strict";
  }
});
...
var ZylemGameElement;
var init_zylem_game2 = __esm({
  "src/web-components/zylem-game.ts"() {
    "use strict";
    init_debug_state();
    ZylemGameElement = class extends HTMLElement {
      _game = null;
      _state = {};
      container;
      constructor() {
...
var init_entity_type_map = __esm({
  "src/lib/types/entity-type-map.ts"() {
    "use strict";
    init_sprite();
    init_sphere();
...
// src/lib/graphics/shaders/fire.shader.ts
var fragment2, fireShader;
var init_fire_shader = __esm({
  "src/lib/graphics/shaders/fire.shader.ts"() {
    "use strict";
    init_object_shader();
    fragment2 = `
...
// src/lib/graphics/shaders/star.shader.ts
var fragment3, starShader;
var init_star_shader = __esm({
  "src/lib/graphics/shaders/star.shader.ts"() {
    "use strict";
    init_object_shader();
    fragment3 = `
...
// src/lib/graphics/shaders/vertex/debug.shader.ts
var debugVertexShader;
var init_debug_shader = __esm({
  "src/lib/graphics/shaders/vertex/debug.shader.ts"() {
    "use strict";
    debugVertexShader = `
uniform vec2 uvScale;
...
// src/lib/graphics/shaders/debug.shader.ts
var fragment4, debugShader;
var init_debug_shader2 = __esm({
  "src/lib/graphics/shaders/debug.shader.ts"() {
    "use strict";
    init_debug_shader();
    fragment4 = `
