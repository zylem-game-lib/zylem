...
import { IComponent, IWorld } from 'bitecs';
 ...
 */
interface BehaviorDescriptor<O extends Record<string, any> = Record<string, any>> {
 ...
 */
interface BehaviorHandle<O extends Record<string, any> = Record<string, any>> {
 ...
 */
interface DefineBehaviorConfig<O extends Record<string, any>> {
 ...
 * ```
 */
declare function defineBehavior<O extends Record<string, any>>(config: DefineBehaviorConfig<O>): BehaviorDescriptor<O>;
...
declare class GameEntity<O extends GameEntityOptions> extends BaseNode<O> implements GameEntityLifeCycle, EntityDebugInfo {
     ...
     */
    use<O extends Record<string, any>>(descriptor: BehaviorDescriptor<O>, options?: Partial<O>): BehaviorHandle<O>;
    /**
...
export { type AnalogState as A, BaseNode as B, type LoadedContext as C, type DestroyFunction as D, EventEmitterDelegate as E, type CleanupContext as F, GameEntity as G, type CollisionContext as H, type InputGamepad as I, type LoadingEvent as L, type MaterialOptions as M, type SetupFunction as S, type TexturePath as T, type UpdateFunction as U, type Vec3 as V, type ZylemEvents as Z, type SetupContext as a, type UpdateContext as b, type DestroyContext as c, type BehaviorSystem as d, type BehaviorSystemFactory as e, type StageEvents as f, type GameEntityOptions as g, type BehaviorCallbackType as h, type BehaviorDescriptor as i, type Behavior as j, type GameEvents as k, type EntityEvents as l, type GameLoadingPayload as m, type StateDispatchPayload as n, type StageConfigPayload as o, type EntityConfigPayload as p, defineBehavior as q, type BehaviorRef as r, type BehaviorHandle as s, type DefineBehaviorConfig as t, type InputPlayerNumber as u, type Inputs as v, type ButtonState as w, GameEntityLifeCycle as x, type IGame as y, zylemEventBus as z };
