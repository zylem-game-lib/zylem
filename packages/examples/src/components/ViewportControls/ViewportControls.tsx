...
const ViewportPresetIcon: Component<{ width: number; height: number }> = (props) => {
	...
	return (
		...
		>
			<div class={styles.toolbarGroup}>
				<span class={styles.toolbarLabel}>Profile</span>
			...
			<div class={styles.toolbarGroup}>
				<span class={styles.toolbarLabel}>Viewport</span>
					...
					{(preset) => (
						...
						>
							<span class={styles.buttonIcon}>
								<ViewportPresetIcon width={preset.width} height={preset.height} />
							</span>
