...
import bailey from './bailey-samba.fbx';
import purpleBed from './purple-bed.gltf';
import cozyBed from './cozy-bed.gltf';
import avocado from './avocado.gltf';
import banana from './banana.gltf';
import playRope from './play-rope.gltf';
import redBone from './red-bone.gltf';
import spikeyBall from './spikey-ball.gltf';
import starby from './starby.gltf';
