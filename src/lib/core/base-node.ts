export class BaseNode<TChildren extends any[] = []> {
	children: TChildren;
	...
	push<TNode extends BaseNode>(node: TNode): BaseNode<[...TChildren, TNode]> {
		this.children.push(node);

		return this as any;
	}

	unshift<TNode extends BaseNode>(num: TNode): BaseNode<[TNode, ...TChildren]> {
		this.children.unshift(num);
