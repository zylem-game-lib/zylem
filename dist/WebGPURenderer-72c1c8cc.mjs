import { t as R, A as E, E as l, H as ne, S as P, n as S, m as oe, B as A, w as k, J as b, K as ae, L as ue, D as ce, M as D, b as M, e as G, N as de } from "./main-0cfba03e.mjs";
import { S as L, b as T, g as z, h as O, r as v, a as C, k as he, U as pe, m as le, l as fe, R as ge } from "./colorToUniform-f42914a9.mjs";
import { c as me, u as _e, U as be, B as ye, G as xe, e as Ge, R as Be, t as Se, S as Pe, a as Te } from "./SharedSystems-e869068f.mjs";
import { C as w } from "./CanvasPool-eb731cd1.mjs";
const y = L.for2d();
class H {
  init() {
    const e = T({
...
class K {
  constructor(e) {
    this._bindGroupHash = /* @__PURE__ */ Object.create(null), this._buffers = [], this._bindGroups = [], this._bufferResources = [], this._renderer = e, this._batchBuffer = new ve({ minUniformOffsetAlignment: _ });
    const t = 256 / _;
    for (let r = 0; r < t; r++) {
  ...
  _createVertexBufferLayouts(e) {
    ...
    return e.buffers.forEach((r) => {
      ...
      for (const n in e.attributes) {
        ...
        (o.divisor ?? 1) !== 1 && k(`Attribute ${n} has an invalid divisor value of '${o.divisor}'. WebGPU only supports a divisor value of 1`), o.buffer === r && (s.arrayStride = o.stride, s.stepMode = o.instance ? "instance" : "vertex", i.push({
...
}, Le = { blockBytes: 4, blockWidth: 1, blockHeight: 1 }, ze = {
  type: "compressed",
  upload(a, e, t) {
    let r = a.pixelWidth, s = a.pixelHeight;
    const i = J[a.format] || Le;
...
class Q {
  ...
  generateCanvas(e) {
    const t = this._renderer, r = t.gpu.device.createCommandEncoder(), s = ce.get().createCanvas();
...
class te {
  ...
  execute(e, t) {
    ...
    let s = t._shader;
    if (!s)
      s = this._shader, s.resources.uTexture = t.texture.source, s.resources.uSampler = t.texture.source.style, s.resources.textureUniforms.uniforms.uTextureMatrix = t.texture.textureMatrix.mapCoord;
    else if (!s.gpuProgram) {
      k("Mesh shader has no gpuProgram", t.shader);
      return;
    }
