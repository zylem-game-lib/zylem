import { t as $, E as l, n as B, D as G, w as b, G as Ne, b as S, L as z, S as g, R as w, J as A, M as Y, e as T, N as Ie } from "./main-0cfba03e.mjs";
import { S as U, d as O, i as q, j as Z, f as P, a as x, n as J, G as ye, U as F, e as Q, R as De } from "./colorToUniform-f42914a9.mjs";
import { g as ee } from "./getBatchSamplersUniformGroup-ca6a8dc1.mjs";
import { e as Ce, G as Ge, c as Ue, b as Oe, U as Pe, R as Fe, B as te, d as N, f as Me, S as Le, a as He } from "./SharedSystems-e869068f.mjs";
class re {
  constructor() {
...
const M = class ne {
   ...
   */
  initFromContext(e) {
    this.gl = e, this.webGLVersion = e instanceof G.get().getWebGLRenderingContext() ? 1 : 2, this.getExtensions(), this.validateContext(e), this._renderer.runners.contextChange.emit(e);
  ...
  validateContext(e) {
    ...
    s.uint32Indices = n || !!i.uint32ElementIndex, s.uniformBufferObject = n, s.vertexArrayObject = n || !!i.vertexArrayObject, s.srgbTextures = n || !!i.srgb, s.nonPowOf2wrapping = n, s.nonPowOf2mipmaps = n, s.msaa = n, s.uint32Indices || b("Provided WebGL context does not support 32 index buffer, large scenes may not render correctly");
  }
};
M.extension = {
  type: [
...
class ae {
  ...
  activateVao(e, r) {
    ...
    for (const c in i) {
      ...
      if (d) {
        ...
        const E = J(u.format), H = ke(u.format);
   ...
   */
  draw(e, r, s, n) {
    const { gl: i } = this._renderer, a = this._activeGeometry, o = Xe[a.topology || e];
...
const We = new Ne({
  ...
  init(e = {}) {
    ...
    this.useBackBuffer = r, this._antialias = s, this._renderer.context.supports.msaa || (b("antialiasing, is not supported on when using the back buffer"), this._antialias = !1), this._state = U.for2d();
    const n = new ye({
      vertex: `
...
function ze(t, e) {
  const r = Math.max(fe[t.data.type] / 16, 1), s = t.data.value.length / t.data.size, n = (4 - s % 4) % 4;
  return `
        v = uv.${t.data.name};
        offset += ${e};
...
class qe {
  ...
  initGpuRenderTarget(e) {
    ...
    return e.colorTexture.resource === r.gl.canvas ? (n.framebuffer = null, n) : (this._initColor(e, n), s.bindFramebuffer(s.FRAMEBUFFER, null), n);
  }
  ...
  _initColor(e, r) {
    ...
    if (r.resolveTargetFramebuffer = i, n.bindFramebuffer(n.FRAMEBUFFER, i), r.width = e.colorTexture.source.pixelWidth, r.height = e.colorTexture.source.pixelHeight, e.colorTextures.forEach((a, o) => {
      const c = a.source;
      c.antialias && (s.context.supports.msaa ? r.msaa = !0 : b("[RenderTexture] Antialiasing on textures is not supported in WebGL1")), s.texture.bindSource(c, 0);
...
function st(t, e) {
  ...
  for (let n = 0; n < s; n++) {
    const i = e.getActiveUniform(t, n), a = i.name.replace(/\[.*?\]$/, ""), o = !!i.name.match(/\[.*?\]$/), c = me(e, i.type);
    r[a] = {
      name: a,
      index: n,
      type: c,
...
function it(t, e) {
  ...
  i && (typeof t.transformFeedbackVaryings != "function" ? b("TransformFeedback is not supported but TransformFeedbackVaryings are given.") : t.transformFeedbackVaryings(
    n,
    i.names,
...
class Ee {
  ...
  bind(e, r) {
    ...
    s || (s = this._shaderSyncFunctions[e.glProgram._key] = this._generateShaderSync(e, this)), s(this._renderer, e, R);
  }
  /**
...
const _t = 0, ft = 1, ht = 2, lt = 3, dt = 4, mt = 5, Se = class C {
  constructor() {
...
class bt {
  constructor(e) {
    this.target = ie.TEXTURE_2D, this.texture = e, this.width = -1, this.height = -1, this.type = f.UNSIGNED_BYTE, this.internalFormat = D.RGBA, this.format = D.RGBA, this.samplerType = 0;
  }
}
const St = {
  id: "buffer",
...
function K(t, e, r, s, n, i, a, o) {
  ...
  if ((!o || t.magFilter !== "linear") && e[n](c, e.TEXTURE_MAG_FILTER, j[t.magFilter]), r) {
    if (!o || t.mipmapFilter !== "linear") {
      const u = vt[t.minFilter][t.mipmapFilter];
      e[n](c, e.TEXTURE_MIN_FILTER, u);
    }
  } else
    e[n](c, e.TEXTURE_MIN_FILTER, j[t.minFilter]);
...
function Bt(t, e) {
  let r = {}, s = t.RGBA;
  return t instanceof G.get().getWebGLRenderingContext() ? e.srgb && (r = {
...
class pe {
  ...
  generateCanvas(e) {
    const { pixels: r, width: s, height: n } = this.getPixels(e), i = G.get().createCanvas();
...
class Re {
  ...
  execute(e, r) {
    ...
    n.groups[0] = i.globalUniforms.bindGroup, i.state.set(e.state), i.shader.bind(n), i.geometry.bind(o, n.glProgram);
...
const It = [
  ...
  _e,
  ce
], yt = [...He], Dt = [re, ve, Re], Te = [], xe = [], Be = [];
T.handleByNamedList(l.WebGLSystem, Te);
T.handleByNamedList(l.WebGLPipes, xe);
T.handleByNamedList(l.WebGLPipesAdaptor, Be);
T.add(...It, ...yt, ...Dt);
class Pt extends Ie {
  constructor() {
    const e = {
